...
/* ERC20 Public variables of the token */
    string public version = 'HDAO 0.1';
    string public name;
...
*/
    ...
    event LogString(bytes32 log); // Event
 ...
 * withdrawal has been requested and is currenctly pending
 */
 ...
 */
    function withdrawalComplete() {
        ...
        if ((r.sinceBlock + blockWait) > block.number) {
            LogString("Need to wait more");
            LogString(uintToBytes(r.sinceBlock + blockWait));
            throw; // too early - need to wait more
        }
...
*/
    function quickWithdraw() payable notPendingWithdrawal {
